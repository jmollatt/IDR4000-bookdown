...
\hypersetup{
  ...
  pdfauthor={Jacob Mollatt - Kandidatnummer 109 - https://github.com/jmollatt/IDR4000-bookdown.git},
  hidelinks,
...
\title{Mappeeksamen}
\author{Jacob Mollatt - Kandidatnummer 109 - \url{https://github.com/jmollatt/IDR4000-bookdown.git}}
\date{2021-12-03}
...
\caption{\label{fig:unnamed-chunk-12}Figur 2 viser gjennomsnittlig belastning på styrketester ved pre-test of post-test for de ulike treningsintervensjonene}
\end{figure}
