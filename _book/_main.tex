...
\caption{\label{fig:unnamed-chunk-10}Figur 2 viser gjennomsnittlig belastning på styrketester ved pre-test of post-test for de ulike treningsintervensjonene}
\end{figure}
