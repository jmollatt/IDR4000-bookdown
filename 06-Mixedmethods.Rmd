...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap= "Figur 1 viser økning i fettfri masse fra pre-test til post-test for samtlige deltakere}
plotdata <- dxadata %>%
  select(participant:include, sex, lean.left_leg, lean.right_leg) %>%
  pivot_longer(names_to = "leg", 
               values_to = "lean.legs", 
